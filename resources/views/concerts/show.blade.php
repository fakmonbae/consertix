    ...
    <div class="bg-white rounded-xl shadow overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('concerts.index') }}" class="inline-flex items-center bg-gray-200 px-4 py-2 rounded-lg">Back</a>
                <a href="#" class="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-lg">Buy Ticket</a>
            </div>
        </div>
    </div>
</div>
